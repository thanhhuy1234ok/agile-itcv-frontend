    ...
    <div style={{display: 'flex'}}>
      <div style={{
        ...
        <div style={{padding: 80}}>
          <Title style={{ textAlign: 'left' }} level={2}>Welcome to ITCV</Title>
          <Text style={{fontSize: 15}}>By signing in, you agree to ITviec’s Terms & Conditions and Privacy Policy in relation to your privacy information.</Text>
